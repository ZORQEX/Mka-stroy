          ...
          >
            ...
            <div className="p-6 space-y-6">
              <div className="prose prose-sm max-w-none text-text-muted leading-relaxed space-y-4">
                <p>{drawerContent.intro || 'Компания ТОО «MKA STROY» предлагает огромный спектр услуг монтажных работ в жилых, производственных и офисных помещениях.'}</p>
                ...
                <p>{drawerContent.services || 'ТОО «MKA STROY» оказывает комплекс услуг по проведению монтажных и пусконаладочных работ внутренних и наружных инженерных сетей зданий и целых промышленных или жилых комплексов, придерживаясь национальных и международных стандартов.'}</p>
                ...
                <p>{drawerContent.quality || 'ТОО «MKA STROY» обеспечит высокое качество выполнения работ в оптимальные сроки и в рамках подходящего бюджета.'}</p>
